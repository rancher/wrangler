...
import (
	...
	admissionreg "github.com/rancher/wrangler/v4/pkg/generated/controllers/admissionregistration.k8s.io"
	admissionregcontrollers "github.com/rancher/wrangler/v4/pkg/generated/controllers/admissionregistration.k8s.io/v1"
	"github.com/rancher/wrangler/v4/pkg/generated/controllers/apiextensions.k8s.io"
	crdcontrollers "github.com/rancher/wrangler/v4/pkg/generated/controllers/apiextensions.k8s.io/v1"
	"github.com/rancher/wrangler/v4/pkg/generated/controllers/apiregistration.k8s.io"
	apicontrollers "github.com/rancher/wrangler/v4/pkg/generated/controllers/apiregistration.k8s.io/v1"
	"github.com/rancher/wrangler/v4/pkg/generated/controllers/apps"
	appcontrollers "github.com/rancher/wrangler/v4/pkg/generated/controllers/apps/v1"
	"github.com/rancher/wrangler/v4/pkg/generated/controllers/batch"
	batchcontrollers "github.com/rancher/wrangler/v4/pkg/generated/controllers/batch/v1"
	"github.com/rancher/wrangler/v4/pkg/generated/controllers/core"
	corecontrollers "github.com/rancher/wrangler/v4/pkg/generated/controllers/core/v1"
	"github.com/rancher/wrangler/v4/pkg/generated/controllers/rbac"
	rbaccontrollers "github.com/rancher/wrangler/v4/pkg/generated/controllers/rbac/v1"
	"github.com/rancher/wrangler/v4/pkg/generic"
	"github.com/rancher/wrangler/v4/pkg/lasso/controller"
	"github.com/rancher/wrangler/v4/pkg/lasso/dynamic"
	"github.com/rancher/wrangler/v4/pkg/ratelimit"
