...
func (c CRD) ToCustomResourceDefinitionV1Beta1() (*apiextv1beta1.CustomResourceDefinition, error) {
	...
	var internalCRD *apiext.CustomResourceDefinition
	...
	var v1beta1CRD *apiextv1beta1.CustomResourceDefinition
	...
	if &v1beta1CRD == nil {
		return nil, fmt.Errorf("conversion resulted in a nil apiextensions v1beta1 CRD object")
	}
