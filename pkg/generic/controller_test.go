...
//go:generate mockgen --build_flags=--mod=mod -package generic -destination ./controllerFactoryMocks_test.go github.com/rancher/wrangler/v4/pkg/lasso/controller SharedControllerFactory,SharedController
