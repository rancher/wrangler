...
type jobController struct {
	*generic.Controller[*v1.Job, *v1.JobList]
}

func (c *jobController) OnChange(ctx context.Context, name string, sync JobHandler) {
	c.Controller.OnChange(ctx, name, generic.ObjectHandler[*v1.Job](sync))
}

func (c *jobController) OnRemove(ctx context.Context, name string, sync JobHandler) {
	c.Controller.OnRemove(ctx, name, generic.ObjectHandler[*v1.Job](sync))
}
...
type jobCache struct {
	*generic.Cache[*v1.Job]
}

func (c *jobCache) AddIndexer(indexName string, indexer JobIndexer) {
	c.Cache.AddIndexer(indexName, generic.Indexer[*v1.Job](indexer))
}
