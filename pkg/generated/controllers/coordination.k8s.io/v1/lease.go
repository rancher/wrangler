...
type LeaseClient interface {
	...
	Create(obj *v1.Lease, options client.CreateOptions) (*v1.Lease, error)

	// Update updates the object and return the newly updated Object or an error.
	Update(obj *v1.Lease, options client.UpdateOptions) (*v1.Lease, error)

	// Delete deletes the Object in the given name.
	Delete(namespace, name string, options client.DeleteOptions) error

	// Get will attempt to retrieve the resource with the specified name.
	Get(namespace, name string, options client.GetOptions) (*v1.Lease, error)

	// List will attempt to find multiple resources.
	List(namespace string, opts client.ListOptions) (*v1.LeaseList, error)

	// Watch will start watching resources.
	Watch(namespace string, opts client.ListOptions) (watch.Interface, error)

	// Patch will patch the resource with the matching name.
	Patch(namespace, name string, pt types.PatchType, data []byte, options client.PatchOptions, subresources ...string) (result *v1.Lease, err error)
}
