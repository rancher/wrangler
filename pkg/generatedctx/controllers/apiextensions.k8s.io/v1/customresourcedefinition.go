...
type CustomResourceDefinitionClient interface {
	generic.NonNamespacedClientInterfaceContext[*v1.CustomResourceDefinition, *v1.CustomResourceDefinitionList]
}
...
type CustomResourceDefinitionStatusHandler func(ctx context.Context, obj *v1.CustomResourceDefinition, status v1.CustomResourceDefinitionStatus) (v1.CustomResourceDefinitionStatus, error)
...
type CustomResourceDefinitionGeneratingHandler func(ctx context.Context, obj *v1.CustomResourceDefinition, status v1.CustomResourceDefinitionStatus) ([]runtime.Object, v1.CustomResourceDefinitionStatus, error)
...
func (a *customResourceDefinitionStatusHandler) sync(ctx context.Context, key string, obj *v1.CustomResourceDefinition) (*v1.CustomResourceDefinition, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *customResourceDefinitionGeneratingHandler) Remove(ctx context.Context, key string, obj *v1.CustomResourceDefinition) (*v1.CustomResourceDefinition, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *customResourceDefinitionGeneratingHandler) Handle(ctx context.Context, obj *v1.CustomResourceDefinition, status v1.CustomResourceDefinitionStatus) (v1.CustomResourceDefinitionStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.CustomResourceDefinitionGeneratingHandler(ctx, obj, status)
	if err != nil {
