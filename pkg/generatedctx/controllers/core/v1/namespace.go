...
type NamespaceClient interface {
	generic.NonNamespacedClientInterfaceContext[*v1.Namespace, *v1.NamespaceList]
}
...
type NamespaceStatusHandler func(ctx context.Context, obj *v1.Namespace, status v1.NamespaceStatus) (v1.NamespaceStatus, error)
...
type NamespaceGeneratingHandler func(ctx context.Context, obj *v1.Namespace, status v1.NamespaceStatus) ([]runtime.Object, v1.NamespaceStatus, error)
...
func (a *namespaceStatusHandler) sync(ctx context.Context, key string, obj *v1.Namespace) (*v1.Namespace, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *namespaceGeneratingHandler) Remove(ctx context.Context, key string, obj *v1.Namespace) (*v1.Namespace, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *namespaceGeneratingHandler) Handle(ctx context.Context, obj *v1.Namespace, status v1.NamespaceStatus) (v1.NamespaceStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.NamespaceGeneratingHandler(ctx, obj, status)
	if err != nil {
