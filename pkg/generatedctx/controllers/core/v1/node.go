...
type NodeClient interface {
	generic.NonNamespacedClientInterfaceContext[*v1.Node, *v1.NodeList]
}
...
type NodeStatusHandler func(ctx context.Context, obj *v1.Node, status v1.NodeStatus) (v1.NodeStatus, error)
...
type NodeGeneratingHandler func(ctx context.Context, obj *v1.Node, status v1.NodeStatus) ([]runtime.Object, v1.NodeStatus, error)
...
func (a *nodeStatusHandler) sync(ctx context.Context, key string, obj *v1.Node) (*v1.Node, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *nodeGeneratingHandler) Remove(ctx context.Context, key string, obj *v1.Node) (*v1.Node, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *nodeGeneratingHandler) Handle(ctx context.Context, obj *v1.Node, status v1.NodeStatus) (v1.NodeStatus, error) {
