...
type PodClient interface {
	generic.ClientInterfaceContext[*v1.Pod, *v1.PodList]
}
...
type PodStatusHandler func(ctx context.Context, obj *v1.Pod, status v1.PodStatus) (v1.PodStatus, error)
...
type PodGeneratingHandler func(ctx context.Context, obj *v1.Pod, status v1.PodStatus) ([]runtime.Object, v1.PodStatus, error)
...
func (a *podStatusHandler) sync(ctx context.Context, key string, obj *v1.Pod) (*v1.Pod, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *podGeneratingHandler) Remove(ctx context.Context, key string, obj *v1.Pod) (*v1.Pod, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *podGeneratingHandler) Handle(ctx context.Context, obj *v1.Pod, status v1.PodStatus) (v1.PodStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.PodGeneratingHandler(ctx, obj, status)
	if err != nil {
