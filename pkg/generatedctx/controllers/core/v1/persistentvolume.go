...
type PersistentVolumeClient interface {
	generic.NonNamespacedClientInterfaceContext[*v1.PersistentVolume, *v1.PersistentVolumeList]
}
...
type PersistentVolumeStatusHandler func(ctx context.Context, obj *v1.PersistentVolume, status v1.PersistentVolumeStatus) (v1.PersistentVolumeStatus, error)
...
type PersistentVolumeGeneratingHandler func(ctx context.Context, obj *v1.PersistentVolume, status v1.PersistentVolumeStatus) ([]runtime.Object, v1.PersistentVolumeStatus, error)
...
func (a *persistentVolumeStatusHandler) sync(ctx context.Context, key string, obj *v1.PersistentVolume) (*v1.PersistentVolume, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *persistentVolumeGeneratingHandler) Remove(ctx context.Context, key string, obj *v1.PersistentVolume) (*v1.PersistentVolume, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *persistentVolumeGeneratingHandler) Handle(ctx context.Context, obj *v1.PersistentVolume, status v1.PersistentVolumeStatus) (v1.PersistentVolumeStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.PersistentVolumeGeneratingHandler(ctx, obj, status)
	if err != nil {
