...
type ServiceClient interface {
	generic.ClientInterfaceContext[*v1.Service, *v1.ServiceList]
}
...
type ServiceStatusHandler func(ctx context.Context, obj *v1.Service, status v1.ServiceStatus) (v1.ServiceStatus, error)
...
type ServiceGeneratingHandler func(ctx context.Context, obj *v1.Service, status v1.ServiceStatus) ([]runtime.Object, v1.ServiceStatus, error)
...
func (a *serviceStatusHandler) sync(ctx context.Context, key string, obj *v1.Service) (*v1.Service, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *serviceGeneratingHandler) Remove(ctx context.Context, key string, obj *v1.Service) (*v1.Service, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *serviceGeneratingHandler) Handle(ctx context.Context, obj *v1.Service, status v1.ServiceStatus) (v1.ServiceStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.ServiceGeneratingHandler(ctx, obj, status)
	if err != nil {
