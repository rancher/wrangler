...
type PersistentVolumeClaimClient interface {
	generic.ClientInterfaceContext[*v1.PersistentVolumeClaim, *v1.PersistentVolumeClaimList]
}
...
type PersistentVolumeClaimStatusHandler func(ctx context.Context, obj *v1.PersistentVolumeClaim, status v1.PersistentVolumeClaimStatus) (v1.PersistentVolumeClaimStatus, error)
...
type PersistentVolumeClaimGeneratingHandler func(ctx context.Context, obj *v1.PersistentVolumeClaim, status v1.PersistentVolumeClaimStatus) ([]runtime.Object, v1.PersistentVolumeClaimStatus, error)
...
func (a *persistentVolumeClaimStatusHandler) sync(ctx context.Context, key string, obj *v1.PersistentVolumeClaim) (*v1.PersistentVolumeClaim, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *persistentVolumeClaimGeneratingHandler) Remove(ctx context.Context, key string, obj *v1.PersistentVolumeClaim) (*v1.PersistentVolumeClaim, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *persistentVolumeClaimGeneratingHandler) Handle(ctx context.Context, obj *v1.PersistentVolumeClaim, status v1.PersistentVolumeClaimStatus) (v1.PersistentVolumeClaimStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.PersistentVolumeClaimGeneratingHandler(ctx, obj, status)
	if err != nil {
