...
type DeploymentClient interface {
	generic.ClientInterfaceContext[*v1.Deployment, *v1.DeploymentList]
}
...
type DeploymentStatusHandler func(ctx context.Context, obj *v1.Deployment, status v1.DeploymentStatus) (v1.DeploymentStatus, error)
...
type DeploymentGeneratingHandler func(ctx context.Context, obj *v1.Deployment, status v1.DeploymentStatus) ([]runtime.Object, v1.DeploymentStatus, error)
...
func (a *deploymentStatusHandler) sync(ctx context.Context, key string, obj *v1.Deployment) (*v1.Deployment, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *deploymentGeneratingHandler) Remove(ctx context.Context, key string, obj *v1.Deployment) (*v1.Deployment, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *deploymentGeneratingHandler) Handle(ctx context.Context, obj *v1.Deployment, status v1.DeploymentStatus) (v1.DeploymentStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.DeploymentGeneratingHandler(ctx, obj, status)
	if err != nil {
