...
type DaemonSetClient interface {
	generic.ClientInterfaceContext[*v1.DaemonSet, *v1.DaemonSetList]
}
...
type DaemonSetStatusHandler func(ctx context.Context, obj *v1.DaemonSet, status v1.DaemonSetStatus) (v1.DaemonSetStatus, error)
...
type DaemonSetGeneratingHandler func(ctx context.Context, obj *v1.DaemonSet, status v1.DaemonSetStatus) ([]runtime.Object, v1.DaemonSetStatus, error)
...
func (a *daemonSetStatusHandler) sync(ctx context.Context, key string, obj *v1.DaemonSet) (*v1.DaemonSet, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *daemonSetGeneratingHandler) Remove(ctx context.Context, key string, obj *v1.DaemonSet) (*v1.DaemonSet, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *daemonSetGeneratingHandler) Handle(ctx context.Context, obj *v1.DaemonSet, status v1.DaemonSetStatus) (v1.DaemonSetStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.DaemonSetGeneratingHandler(ctx, obj, status)
	if err != nil {
