...
type StatefulSetClient interface {
	generic.ClientInterfaceContext[*v1.StatefulSet, *v1.StatefulSetList]
}
...
type StatefulSetStatusHandler func(ctx context.Context, obj *v1.StatefulSet, status v1.StatefulSetStatus) (v1.StatefulSetStatus, error)
...
type StatefulSetGeneratingHandler func(ctx context.Context, obj *v1.StatefulSet, status v1.StatefulSetStatus) ([]runtime.Object, v1.StatefulSetStatus, error)
...
func (a *statefulSetStatusHandler) sync(ctx context.Context, key string, obj *v1.StatefulSet) (*v1.StatefulSet, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *statefulSetGeneratingHandler) Remove(ctx context.Context, key string, obj *v1.StatefulSet) (*v1.StatefulSet, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *statefulSetGeneratingHandler) Handle(ctx context.Context, obj *v1.StatefulSet, status v1.StatefulSetStatus) (v1.StatefulSetStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.StatefulSetGeneratingHandler(ctx, obj, status)
	if err != nil {
