...
type APIServiceClient interface {
	generic.NonNamespacedClientInterfaceContext[*v1.APIService, *v1.APIServiceList]
}
...
type APIServiceStatusHandler func(ctx context.Context, obj *v1.APIService, status v1.APIServiceStatus) (v1.APIServiceStatus, error)
...
type APIServiceGeneratingHandler func(ctx context.Context, obj *v1.APIService, status v1.APIServiceStatus) ([]runtime.Object, v1.APIServiceStatus, error)
...
func (a *aPIServiceStatusHandler) sync(ctx context.Context, key string, obj *v1.APIService) (*v1.APIService, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *aPIServiceGeneratingHandler) Remove(ctx context.Context, key string, obj *v1.APIService) (*v1.APIService, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *aPIServiceGeneratingHandler) Handle(ctx context.Context, obj *v1.APIService, status v1.APIServiceStatus) (v1.APIServiceStatus, error) {
