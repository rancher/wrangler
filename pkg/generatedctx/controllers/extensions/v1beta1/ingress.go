...
type IngressClient interface {
	generic.ClientInterfaceContext[*v1beta1.Ingress, *v1beta1.IngressList]
}
...
type IngressStatusHandler func(ctx context.Context, obj *v1beta1.Ingress, status v1beta1.IngressStatus) (v1beta1.IngressStatus, error)
...
type IngressGeneratingHandler func(ctx context.Context, obj *v1beta1.Ingress, status v1beta1.IngressStatus) ([]runtime.Object, v1beta1.IngressStatus, error)
...
func (a *ingressStatusHandler) sync(ctx context.Context, key string, obj *v1beta1.Ingress) (*v1beta1.Ingress, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *ingressGeneratingHandler) Remove(ctx context.Context, key string, obj *v1beta1.Ingress) (*v1beta1.Ingress, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *ingressGeneratingHandler) Handle(ctx context.Context, obj *v1beta1.Ingress, status v1beta1.IngressStatus) (v1beta1.IngressStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.IngressGeneratingHandler(ctx, obj, status)
	if err != nil {
