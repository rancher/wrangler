...
type JobClient interface {
	generic.ClientInterfaceContext[*v1.Job, *v1.JobList]
}
...
type JobStatusHandler func(ctx context.Context, obj *v1.Job, status v1.JobStatus) (v1.JobStatus, error)
...
type JobGeneratingHandler func(ctx context.Context, obj *v1.Job, status v1.JobStatus) ([]runtime.Object, v1.JobStatus, error)
...
func (a *jobStatusHandler) sync(ctx context.Context, key string, obj *v1.Job) (*v1.Job, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *jobGeneratingHandler) Remove(ctx context.Context, key string, obj *v1.Job) (*v1.Job, error) {
	if obj != nil {
		return obj, nil
	}
...
func (a *jobGeneratingHandler) Handle(ctx context.Context, obj *v1.Job, status v1.JobStatus) (v1.JobStatus, error) {
	if !obj.DeletionTimestamp.IsZero() {
		return status, nil
	}

	objs, newStatus, err := a.JobGeneratingHandler(ctx, obj, status)
	if err != nil {
