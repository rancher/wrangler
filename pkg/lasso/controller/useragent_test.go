...
//go:generate mockgen --build_flags=--mod=mod -package controller -destination ./mocks_test.go github.com/rancher/wrangler/v4/pkg/lasso/controller SharedController
